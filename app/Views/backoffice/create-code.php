...
<head>
  ...
  <title>Créer un code - VitalVibe</title>
...
<body>
  ...
  <div class="creation-card">
    ...
    <form action="/admin/codes/create" method="post" class="activity-form">
      ...
      <button type="submit" class="btn-submit">Valider et Créer le Code</button>
    </form>
