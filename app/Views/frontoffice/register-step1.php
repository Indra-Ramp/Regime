            ...
            <form action="<?= base_url('/register/1') ?>" method="POST">
                ...
                <fieldset class="form-section">
                    ...
                    <div class="input-row">
                        <div class="input-group">
                            ...
                            <input type="text" id="nom" name="nom" class="<?= isset($errors['nom']) ? 'input-error' : '' ?>" placeholder="Nom" value="<?= esc($inputs['nom']) ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="prenom" name="prenom" class="<?= isset($errors['prenom']) ? 'input-error' : '' ?>" placeholder="Prénom" value="<?= esc($inputs['prenom']) ?>">
                ...
                <fieldset class="form-section">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" class="<?= isset($errors['email']) ? 'input-error' : '' ?>" placeholder="nom@exemple.com" value="<?= esc($inputs['email']) ?>">
